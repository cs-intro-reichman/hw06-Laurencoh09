...
public class Runigram {
	...
	public static void main(String[] args) {
		...
		Color[][] flippedpic = graySqualed(tinypic);
		print(flippedpic);
	...
	public static Color[][] flippedHorizontally(Color[][] image) {
		Color[][] image1 = new Color[image.length][image[0].length];
		 for (i = 0; i < image.lenght; i++) {
			  for (j = 0; j < image[0].lenght; j++) {
		image1[i][j] = image[i](image[0].lenght - 1 - j);		 
		          }
		 }	 
	return image1;
	...
	public static Color[][] flippedVertically(Color[][] image){
		Color[][] image1 = new Color[image.length][image[0].length];
		 for (i = 0; i < image.lenght; i++) {
			  for (j = 0; j < image[0].lenght; j++) {
		image1[i][j] = image[j](image.lenght - 1 - i);
	...
	double height2 = ((double) height1 / height);
	double width2 = ((double) width1 / width);
		for (int i = 0; i < height; i++) {
			for (int j = 0; j < width; j++) {
				int scaled_height = (int) (i * height2);
				int scaled_width = (int) (j * width2);
